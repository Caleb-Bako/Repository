            ...
            <div className="main">
                <div className="single-doc">
                        <div className="add-file">
                                <div>
                                    <h2 className="instrcs">Repository</h2>
                                </div>
                                <div>
                                    <Link className="add-file-btn" to={'/home/new'}>+ Add Files</Link>
                                </div>
                        </div>
                        <div className="folder-titles">
                            ...
                            <div>
                                {staff.length > 0 && staff.map(staf =>(
                                    <Link to={`/home/${staf._id}`} className="staff-content" >
                                    <div className="file-strstt">
                                        <div>
